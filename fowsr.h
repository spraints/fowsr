...
#define WS_SCALE_MS_TO_KMH      (3600.0            * 0.001)
...
struct ws_record2 multimon_format[] = {
    ...
    {"temperature"  , WS_TEMPERATURE_OUT , ss , WS_SCALE_DEFAULT        , WS_OFFSET_DEFAULT},   // - [temperature °C]
...
#define WS_MULTIMON_DAILY_RAIN  5   // Position of daily rain parameter
#define WS_MULTIMON_PRESSURE    7   // Position of pressure parameter
#define WS_MULTIMON_RECORDS     8
...
// Convert semi-colon seperated line of data to Json string
